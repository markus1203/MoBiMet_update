...
PET=str(13.4)
#dht22_humidity=str(-9999)
#dht22_temperature=str(-9999)
...
#draw.text((2,130), 'PET: '+"{0:.1f}".format(PET) + u' °C', font = font18, fill = 0)
...
#drawblack.text((2,130), 'PET: '+PET+u' °C', font = font18, fill = 0)
